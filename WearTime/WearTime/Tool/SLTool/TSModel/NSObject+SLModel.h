 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `SLModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
     ...
     int main() {
         ...
         YYBook *book = [YYBook sl_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book sl_modelToJSONString];
     ...
     ********************** Coding/Copying/hash/equal *********************
     ...
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self sl_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self sl_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self sl_modelCopy]; }
     - (NSUInteger)hash { return [self sl_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self sl_modelIsEqual:object]; }
     @end
 ...
 */
- (nullable id)sl_modelToJSONObject;
 ...
 */
- (nullable NSData *)sl_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)sl_modelToJSONString;
 ...
 */
+ (nullable NSArray *)sl_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
+ (nullable NSDictionary *)sl_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<SLModel>' to your class header.
 */
